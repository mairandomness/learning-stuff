...
int main(int argc, char *argv[])
{
	...
	printf("What's your Fisrt Name? ");
	in = fgets(you.first_name, MAX_DATA -1, stdin);
	// use fgets for string instead of scanf because it doesnt have a buffer issue
	...
	printf("First Name: %s", you.first_name);  //the names don't need \n because of fgets?
